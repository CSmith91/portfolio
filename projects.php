        ...
        <main>
            <section id="projects">
                ...
                <div class="project">
                    ...
                    <!-- <div class="carousel-container">
                        <div class="carousel">
                            <img src="./images/ima_main.png" alt="main page" class="ima_img">
                            <img src="./images/ima_auction.png" alt="auction page" class="ima_img">
                            <img src="./images/ima_individual_lot.png" alt="lot" class="ima_img">
                            <img src="./images/ima_lots.png" alt="lots back office" class="ima_img">
                            <img src="./images/ima_customObject.png" alt="custom object" class="ima_img">
                            <img src="./images/ima_pod_extended.png" alt="pod extended" class="ima_img">
                            <img src="./images/ima_pod_script.png" alt="pod script" class="ima_img">
                        </div>
            ...
            <section id="flowbird-crm">
                ...
                <div class="case-studies">
                    ...
                    <ul>
                        <li id="shopify-ex">Customising Shopify templates. I worked on changing all the styling for set of automated emails beign sent out from a client's shopify to their customers. The design was to fit in with their website's aesthetic (fonts, colours, sizes, images, etc) and covered checkout, checkout-pending, delivery confirmation and other updates. <a href="https://arksenlabs.com/" target="_blank">You can see the styling here</a>.</li>    
                        <li>Postcode automation. This was one of my favourite projects. Alongside other integration and automations for this client, we looked into creating postcode regions for the client to ascertain which regions were more valuable (i.e. for their sales team to focus on). This involved a lot of data export, cleanign and reimport, as the system had a thousands of postcodes - some of which were incompelte. Another obstacle was Pipedrive uses Google Map's API to autofill addresses, which are populate address fields inconsistently. With the data cleaned and imported, we needed to also create an alogrith to can new instance of 'bad addresses' and either flag this to the CRM user, auto-handle this within our integration, or otherwise give it a custom label. We also setup linked to their ERP systems for the automation of draft invoices and data cleaning. The data cleaning involved scouring the CRM's data store (mounting this within Make one take and later adding to it as more deals are created) and then creating an algorithm to search for duplicate deals that may be created by the client's sales team. <a href="https://flowbird.co.uk/blog/filter-leads-pipedrive-with-make" target="_blank">More info here</a>.</li>
                    </ul>
                    <h3>Work Ethic</h3>
                    <div class="paragraph-container">
                        ...
                        <div class="image-container">
                            <img src="./images/flowbird_outing.png" alt="flowbird outing" class="static" style="align-items: center">
                        </div>
                        <p>Growing my team, I rewarded one colleague’s successes by promoting them to a lead role and got another to pass their probation following their training.
                        ...
                        <p>To combat challenging times, I setup ‘protected time’ for training and emails for tasks that needed clarification. I encouraged my team to do the same, reserving the first thirty minutes for training.  
                            </p>
                    </div>
                </div>
            </section>
            ...
            <section id="education-certificates">
                ...
                <div class="sub-section">
                    <ul>
                        ...
                        <li><a href="./docs/HyperionDev Certificate.pdf" target="_blank">Hyperion Dev Web Development Bootcamp</a></li>
                    </ul>
                    <h4>Final Year Group Project</h4>
                    <ul>
                        <li><a href="./docs/Final Project Full Writeup v0.7.pdf" target="_blank">Report typed and formatting using LaTeX.</a></li>
                    </ul>
                    <h3>Other Qualifications</h3>
                    <ul>
                        <li><a href="./docs/Make1.pdf" target="_blank">Make - Foundation</a></li>
                        <li><a href="./docs/Make2.pdf" target="_blank">Make - Basic</a></li>
                        <li><a href="./docs/Make3.pdf" target="_blank">Make - Intermediate</a></li>
                        <li><a href="./docs/HS CMS Implementation.png" target="_blank">HubSpot CMS Implementation</a></li>
                        <li><a href="./docs/HS CMS Developer.png" target="_blank">HubSpot CMS Developer</a></li>
                        <li><a href="./docs/HS contextual.png" target="_blank">HubSpot Contextual Marketing</a></li>
                    </ul>
                </div>
            </section>
            ...
            <section id="personal-projects">
                ...
                <div class="sub-section">
                    <ul>
                        <li>
                            See my <a href="https://applewell.xyz/miner/v3.4/miner.html" target="_blank">Javascript skills</a> with this clicker game! Note that this is a side-project and always updating, so feel free to stop by whenever!
                        </li>
                        <li>
                            <a href="https://github.com/CSmith91/Hangman-React-Redux" target="_blank">A game of hangman using React-Redux</a>
                        </li>
                        <li>
                            <a href="./docs/Character Gen.xlsx" target="_blank">Download my Dungeon & Dragons automatic character creator</a> - created entirely using Excel!
                        </li>
                    </ul>
                </div>
            </section>
